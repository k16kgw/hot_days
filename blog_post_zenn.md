...
※ 本記事はClaude codeのOpus 4.7でプログラムコードを作成し、Sonnet 4.6で記事本文の執筆および細かい編集を行いました。また、「はじめに」「おわりに」については人力で執筆しました。
なお、主要な出力結果については正確性を確認しており、全体のデータの傾向についても妥当であることを確認してあります。
プロジェクト本体は[https://github.com/k16kgw/hot_days.git](https://github.com/k16kgw/hot_days.git)にあります。

# はじめに

近年、千葉県勝浦市が首都圏から車で90分で行ける避暑地として有名らしい。勝浦市は年間猛暑日日数がこれまで常に0日を記録しているという。そこで今回、年間猛暑日日数が0日の地点を日本全国から網羅的に探し、避暑地として相応しい地域をリストアップしようと考えた。
参考にするデータは気象庁（JMA）の公開統計データとし、特に2016〜2025年の10年間分を全国の観測地点についてwebスクレイピングで集計し、可視化するPythonのプロジェクトを作成した。
